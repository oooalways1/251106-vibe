...
const Shop = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<'hat' | 'clothes' | 'accessory' | 'background'>('hat');
  ...
  const shopItems: CharacterItem[] = [
    ...
    // 배경
    { id: 'bg_1', type: 'background', name: '우주 배경', image: '🌌', price: 350, owned: false, equipped: false },
    { id: 'bg_2', type: 'background', name: '무지개 배경', image: '🌈', price: 300, owned: false, equipped: false },
    { id: 'bg_3', type: 'background', name: '성 배경', image: '🏰', price: 400, owned: false, equipped: false },
  ];
  ...
  const categories = [
    ...
    { value: 'background' as const, label: '배경', emoji: '🖼️' },
  ];
