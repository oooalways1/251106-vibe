...
const GamePlay = () => {
  ...
  const [showVisualHelp, setShowVisualHelp] = useState(settings.showVisualHelp);
  ...
  const hasRemainder = currentProblem.type === 'division' && currentProblem.remainder !== undefined && currentProblem.remainder > 0;
  ...
  const handleNumberClick = (num: string) => {
    if (hasRemainder && remainderInput.length < 2) {
      // 나머지 입력 중
      return;
    }
  ...
  const handleBackspace = () => {
    if (hasRemainder && remainderInput) {
      setRemainderInput(remainderInput.slice(0, -1));
    } else {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            {/* 시각적 도움 */}
            {showVisualHelp && currentProblem.visualHelp && (
              <div className="mb-6">
                <VisualHelp visualHelp={currentProblem.visualHelp} />
              </div>
            )}
            ...
            <div className="bg-gray-50 rounded-2xl p-6 mb-4">
              <div className="text-center mb-4">
                ...
                <div className="text-6xl font-bold text-primary-600 min-h-[80px] flex items-center justify-center">
                  {userInput || '_'}
                </div>
              </div>
              ...
              {hasRemainder && (
                <div className="text-center">
                  ...
                  <div className="text-5xl font-bold text-secondary-600 min-h-[70px] flex items-center justify-center">
                    {remainderInput || '_'}
                  </div>
                </div>
              )}
